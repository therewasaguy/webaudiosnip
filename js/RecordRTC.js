...
AudioContext = context; //window.webkitAudioContext || window.mozAudioContext;
...
function StereoAudioRecorder(mediaStream, root) {
    ...
    volume.connect(analyserR);
    analyserR.connect(__stereoAudioRecorderJavacriptNode);
